...
export function buildThermalPrintHtml(
  ...
  // Leave ~6mm margin on each side; QR square fills the rest
  const qrSizeMm = paperWidthMm - 12;

  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
<title>Print QR - ${esc(name)}</title>
<style>
  @page {
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  @media screen {
    body { outline: 1px dashed #ccc; margin: 20px auto; }
  }
</style>
</head>
<body>
  ...
  <div class="cta">Scan to leave feedback</div>
